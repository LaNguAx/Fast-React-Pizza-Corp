...
function Order() {
  ...
  useEffect(() => {
    const clear = searchParams.get("clearcart");
    if (!clear) return;
  ...
  return (
    <div className="py-6 px-4 sm:px-0 space-y-8">
      ...
      <div className="flex items-start justify-between flex-wrap gap-2 bg-stone-200 py-5 px-6 rounded-md">
      ...
      <div className="space-y-2 bg-stone-200 py-5 px-6 rounded-md">
        <p className="text-sm font-med text-stone-600">
